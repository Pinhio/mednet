...
class Cervix30Dataset(Dataset):
    ...
    def __init__(self, img_list, sets):
        ...
        img_name, label = self.img_list[0].split("\t")
    ...
    def __getitem__(self, idx):
        ...
        img_name, label = self.img_list[idx].split("\t")
        assert os.path.isfile(img_name)
    ...
    def __training_data_process__(self, data): 
        ...
        # get_fdata : Return floating point image data with necessary scaling applied
        data = data.get_fdata()
        #print("Datashape beginning:", data.shape)
        ...
        #print("Shape after resize:", data.shape)
